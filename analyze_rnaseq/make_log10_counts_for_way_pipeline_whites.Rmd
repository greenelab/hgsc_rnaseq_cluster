---
title: "make_lognorm_whites_AACES_data"
...
# we will KEEP all samples that are from white women
...
gene_expr_file = file.path(proj_dir, 
                    "/data/rna_seq_whites/salmon_raw_counts_for_way_pipeline_allCHR_whites.tsv")
...
gene_expr_file = file.path(proj_dir, 
                    "/data/rna_seq_whites/salmon_normalized_filtered_for_way_pipeline_allCHR_whites.tsv")
...
gene_expr_file = file.path(proj_dir, 
                    "/data/rna_seq_whites/salmon_normalized_filtered_for_way_pipeline_bottom5Removed_whites.tsv")
...
gene_expr_file = file.path(proj_dir, 
                    "/data/rna_seq_whites/salmon_normalized_filtered_for_way_pipeline_bottom5Removed_allCHR_whites.tsv")
write.table(filt_samps, gene_expr_file, sep="\t")
