...
AnalSet <- AnalSet[AnalSet$FewerStage > 2, ]
...
Distributions_LateStage <- rbind(SchildkrautB_n, SchildkrautW_n, TCGA_n,MAYO_n,TOTH_n,YOSH_n)
write.csv(Distributions_Drop10, file="distributions_latestage.csv")
...
coxSum <- function (coxData, name) {
  ...
  CoxPHtmploc = file.path(fig_dir, "AllData_COXPHoutput_latestage.csv")
...
coxSum <- function (coxData, name) {
  ...
  CoxPHtmploc = file.path(fig_dir, "AACESBCOXPHoutput_latestage.csv")
  write.csv(CoxPHtmp, file=CoxPHtmploc)
}
...
coxSum <- function (coxData, name) {
  ...
  # Combine together and write to file
  CoxPHtmp <- cbind(conf.int, hazard, Pvalues)
  CoxPHtmploc = file.path(fig_dir, "AACESWCOXPHoutput_latestage.csv")
  write.csv(CoxPHtmp, file=CoxPHtmploc)
}
...
coxSum <- function (coxData, name) {
  ...
  # Combine together and write to file
  CoxPHtmp <- cbind(conf.int, hazard, Pvalues)
  CoxPHtmploc = file.path(fig_dir, "TCGACOXPHoutput_latestage.csv")
  write.csv(CoxPHtmp, file=CoxPHtmploc)
}
...
coxSum <- function (coxData, name) {
  ...
  # Combine together and write to file
  CoxPHtmp <- cbind(conf.int, hazard, Pvalues)
  CoxPHtmploc = file.path(fig_dir, "MAYOCOXPHoutput_latestage.csv")
  write.csv(CoxPHtmp, file=CoxPHtmploc)
}
...
coxSum <- function (coxData, name) {
  ...
  # Combine together and write to file
  CoxPHtmp <- cbind(conf.int, hazard, Pvalues)
  CoxPHtmploc = file.path(fig_dir, "TOTHCOXPHoutput_latestage.csv")
  write.csv(CoxPHtmp, file=CoxPHtmploc)
}
...
coxSum <- function (coxData, name) {
  ...
  # Combine together and write to file
  CoxPHtmp <- cbind(conf.int, hazard, Pvalues, WaldsP)
  CoxPHtmploc = file.path(fig_dir, "YOSHCOXPHoutput_latestage.csv")
  write.csv(CoxPHtmp, file=CoxPHtmploc)
}
